...
discrepancies.to_csv(path+'discrepancies.csv')
del (liveComp, liveCompSub, discrepancies1, discrepancies2, discrepancies3)
...
pivot.to_csv("/Users/JohnTindel/Documents/Work/Data Library/output.csv")
pivot=pd.read_csv("/Users/JohnTindel/Documents/Work/Data Library/output.csv")
